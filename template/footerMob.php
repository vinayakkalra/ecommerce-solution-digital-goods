<!-- footer text start -->
<div class="jumbotron g" style="margin-bottom:0px;">
    ...
    <div class="container-fluid" id="footbg">
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                    <p class="text font-Lato-Regular"  style="font-size: 12px; text-align: center; font-weight: bold; color: rgba(153, 143, 143, 0.979); ">Copyright 2020 © Data Export</p>
                </div>
            </div>
        </div>
    </div>
