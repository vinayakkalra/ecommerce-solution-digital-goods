    ...
    <div class="d-none d-lg-block">
        ...
        <div class="container" style="border-top: 1px solid rgb(221, 221, 221); padding: 20px 0px;">
            <div style="width:100%;" >
                ...
                <p class="font-Lato-Regular" style="color:#2b2b2b; margin:0px 0px 20.8px">
                    We use your Personal Information for providing and improving the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible at http://localhost/dataexport.in
                </p>
                <h2 class="font-Lato-Regular" style="color:#2b2b2b; margin:0px 0px 20.8px;font-size: 25.6px; font-weight: 700;">
    ...
    <div class="d-lg-none position-relative">
         ...
         <div class="container" style="border-top: 1px solid rgb(221, 221, 221); padding: 20px 0px;">
            <div style="width:100%;padding: 0 15px 30px;" >
                ...
                <h2 class="font-Lato-Regular" style="color:#2b2b2b; margin:0px 0px 20.8px;font-size: 19.2px; font-weight: 700;">
                    Information Collection And Use
                </h2>
                <p class="font-Lato-Regular" style="color:#2b2b2b; margin:0px 0px 20.8px">
                    While using our Service, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you. Personally identifiable information (“Personal Information”) may include, but is not limited to:
